...
export default defineMessages(
  {
    ...
    "demo.exportConfirm": "Live Demo 文件包含原始对话事件、推理详情、工具数据和嵌入的产出文件。请在分享前检查其中是否有敏感信息。确定继续导出吗？",
    "demo.privacyNotice": "隐私提示：导出的文件包含原始事件、推理详情、工具数据及产出文件，分享前请先检查。",
    "demo.reselect": "重新选择",
    "demo.error.build": "生成 demo 失败",
    "demo.error.parse": "无法读取该文件",
    "demo.error.tooLarge": "Live Demo 文件超过 {size} MB 上限",
    ...
    "demo.trace.empty": "此 Demo 的推理图没有节点，无法播放。请选择一次产生了 Trace 节点的对话，或导入包含节点的 demo。",
    ...
    "demo.transport.slider": "回放进度（按节点步数）",
  ...
  },
  {
    ...
    "demo.exportConfirm": "A Live Demo contains raw conversation events, reasoning details, tool data, and embedded output files. Review it for sensitive information before sharing. Continue exporting?",
    "demo.privacyNotice": "Privacy: exports include raw events, reasoning details, tool data, and output files. Review them before sharing.",
    "demo.reselect": "Start over",
    "demo.error.build": "Failed to generate demo",
    "demo.error.parse": "Could not read that file",
    "demo.error.tooLarge": "The Live Demo file exceeds the {size} MB limit",
    ...
    "demo.trace.empty": "This demo has no Trace nodes, so playback is unavailable. Choose a conversation that produced Trace nodes, or import a demo that includes them.",
    ...
    "demo.transport.slider": "Playback position by node step",
