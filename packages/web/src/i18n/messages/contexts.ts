...
export default defineMessages(
  {
    ...
    "ctx.session.toolNotCancellable": "无法单独停止此脚本，请使用“停止任务”",
    "ctx.session.toolInterruptTimeout": "脚本未能在 10 秒内停止，请使用“停止任务”",
  ...
  },
  {
    ...
    "ctx.session.toolNotCancellable": "This script cannot be stopped separately. Use Stop task.",
    "ctx.session.toolInterruptTimeout": "The script did not stop within 10 seconds. Use Stop task.",
