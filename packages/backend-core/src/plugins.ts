...
const BUILTIN_PLUGIN_RELEASES: readonly BuiltinPluginRelease[] = [
  {
    ...
    releaseNotes: "Adds managed finite background jobs, terminal notifications, and BrainPilot 0.2 compatibility.",
  ...
  },
  {
    ...
    version: "0.1.1",
    publishedAt: "2026-08-22T00:00:00.000Z",
    releaseNotes: "Validates the NIfTI metadata and central-slice preview against BrainPilot 0.2.",
  },
  {
    plugin: "nifti-viewer",
  ...
  {
    plugin: "superpowers",
    source: "superpowers/6.2.1-bp.1",
    version: "6.2.1-bp.1",
    publishedAt: "2026-08-22T00:00:00.000Z",
    releaseNotes: "Repackages upstream Superpowers 6.2.0 with verified BrainPilot 0.2 compatibility metadata.",
  ...
  },
  {
    ...
    source: "playwright-mcp/0.0.79-bp.1",
    version: "0.0.79-bp.1",
    publishedAt: "2026-08-22T00:00:00.000Z",
    releaseNotes: "Repackages Microsoft Playwright MCP 0.0.78 with verified BrainPilot 0.2 compatibility metadata.",
    publisher: "Microsoft",
    verified: true,
    sourceFormat: "brainpilot",
