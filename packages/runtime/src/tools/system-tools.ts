...
export const AGENT_TOOL_CONFIG: Record<string, string[]> = {
  ...
  engineer: [
    "dispatch_task", "cancel_task", "complete_task", "record_trace", "spawn_subagent", "wait_subagent", "get_subagent", "cancel_subagent", "list_subagent_profiles", "start_monitor", "list_monitors", "stop_monitor", "skill_search",
    "get_domain_knowledge_local", "search_papers_local",
  ],
  experimentalist: [
    "dispatch_task", "cancel_task", "complete_task", "record_trace", "spawn_subagent", "wait_subagent", "get_subagent", "cancel_subagent", "list_subagent_profiles", "start_monitor", "list_monitors", "stop_monitor", "skill_search",
