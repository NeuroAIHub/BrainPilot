#!/usr/bin/env python3
"""Extract and merge HCP Aging phenotype data.

Reads HCP-A phenotype CSV files (cognitive, health, demographic)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Extract HCP Aging phenotype data.")
    parser.add_argument("--phenotype-files", required=True, nargs="+")
    parser.add_argument("--output", required=True)
    parser.add_argument("--imaging-ids", help="Text file with imaging subject IDs")
